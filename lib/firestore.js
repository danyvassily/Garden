...
export const addPost = async (text, user, parentId = null, fileData = null, locationData = null) => {
  try {
    console.log("Préparation des données du post...");
    const postData = {
      text,
      authorId: user.uid,
    ...
    console.log("Appel de addDoc avec", postData);
    const docRef = await addDoc(collection(db, "posts"), postData);
    console.log("addDoc a réussi. ID:", docRef.id);
    return docRef.id;
  } catch (error) {
